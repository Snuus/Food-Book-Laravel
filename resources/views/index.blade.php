            ...
            <div class="container">
                <div class="rc-carousel nav-control-layout2" data-loop="true" data-items="30" data-margin="5"
                    ...
                    <div class="ranna-slider-content-layout2">
                        <figure class="item-figure"><a href="single-recipe.blade.php"><img src="img/slider/slide1-1.jpg"
                                                                                           alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">SALAD</span>
                            <h2 class="item-title"><a href="single-recipe.blade.php">Italiano Salad Mixed</a></h2>
                    ...
                    <div class="ranna-slider-content-layout2">
                        <figure class="item-figure"><a href="single-recipe.blade.php"><img src="img/slider/slide1-2.jpg"
                                                                                           alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">SALAD</span>
                            <h2 class="item-title"><a href="single-recipe.blade.php">Italiano Salad Mixed</a></h2>
                    ...
                    <div class="ranna-slider-content-layout2">
                        <figure class="item-figure"><a href="single-recipe.blade.php"><img src="img/slider/slide1-3.jpg"
                                                                                           alt="Product"></a></figure>
                        <div class="item-content">
                            <span class="sub-title">SALAD</span>
                            <h2 class="item-title"><a href="single-recipe.blade.php">Italiano Salad Mixed</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="product-box-layout4">
                            <div class="item-figure">
                                ...
                                <a href="single-recipe.blade.php" class="item-dot">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </a>
                            ...
                            <div class="item-content">
                                ...
                                <h3 class="item-title"><a href="single-recipe.blade.php">Tomatoes Stuffed with Foie and
                                        Chanterelles</a></h3>
                                <ul class="item-rating">
                                    <li class="star-fill"><i class="fas fa-star"></i></li>
                                    <li class="star-fill"><i class="fas fa-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="product-box-layout4">
                            ...
                            <div class="item-content">
                                ...
                                <h3 class="item-title"><a href="single-recipe.blade.php">Pumpkin Cheesecake With
                    ...
                    <div class="col-lg-4 d-block d-md-none d-lg-block col-sm-12">
                        <div class="product-box-layout4">
                            ...
                            <div class="item-content">
                                ...
                                <h3 class="item-title"><a href="single-recipe.blade.php">Blueberry Juice with Lemon Crema</a></h3>
                                <ul class="item-rating">
                                    <li class="star-fill"><i class="fas fa-star"></i></li>
                                    <li class="star-fill"><i class="fas fa-star"></i></li>
                                    <li class="star-fill"><i class="fas fa-star"></i></li>
                            ...
                            <div class="col-12">
                                <div class="product-box-layout4">
                                    ...
                                    <div class="item-content">
                                        ...
                                        <h2 class="item-title"><a href="single-recipe.blade.php">Chanterelle and Porcini
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="product-box-layout4">
                                    ...
                                    <div class="item-content">
                                        ...
                                        <h3 class="item-title"><a href="single-recipe.blade.php">Tomatoes Stuffed with Foie
                    ...
                    <div class="row gutters-40">
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="product-box-layout5">
                                ...
                                <div class="item-content">
                                    <span class="sub-title">BREAKFAST</span>
                                    <h3 class="item-title"><a href="single-recipe.blade.php">Old School Pancakes So
                            ...
                            <div class="row gutters-40">
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="product-box-layout6">
                                        ...
                                        <div class="item-content">
                                            <span class="sub-title">BREAKFAST</span>
                                            <h3 class="item-title"><a href="single-recipe.blade.php">Asian Chicken Noodles</a></h3>
                                            <ul class="item-rating">
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="product-box-layout6">
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h3 class="item-title"><a href="single-recipe.blade.php">Italiano Salad Mixed</a></h3>
                                            <ul class="item-rating">
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                ...
                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="product-box-layout6">
                                        ...
                                        <div class="item-content">
                                            <span class="sub-title">SALAD</span>
                                            <h3 class="item-title"><a href="single-recipe.blade.php">Maxican Dessert</a></h3>
                                            <ul class="item-rating">
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
                                                <li class="star-fill"><i class="fas fa-star"></i></li>
